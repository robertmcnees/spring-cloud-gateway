 ...
 */
public class SplitRequestGatewayFilterFactoryTests {

	@Test
	public void testSplitRequestWorks() {
		HashMap<String, String> variables = new HashMap<>();
		testFilter("/bar", "/bar", variables);
	}

	private void testFilter(String template, String expectedPath, HashMap<String, String> variables) {
		GatewayFilter filter = new SplitRequestGatewayFilterFactory().apply(c -> c.setTemplate(template));
